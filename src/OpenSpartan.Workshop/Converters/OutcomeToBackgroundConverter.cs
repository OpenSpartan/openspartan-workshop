...
namespace OpenSpartan.Workshop.Converters
{
    internal sealed class OutcomeToBackgroundConverter : IValueConverter
    {
        ...
        private static SolidColorBrush DidNotFinishBrush =>
            _didNotFinishBrush ??= new SolidColorBrush(Windows.UI.Color.FromArgb(50, 115, 103, 240));
        private static SolidColorBrush LossBrush =>
            _lossBrush ??= new SolidColorBrush(Windows.UI.Color.FromArgb(50, 234, 84, 85));
        private static SolidColorBrush TieBrush =>
            _tieBrush ??= new SolidColorBrush(Windows.UI.Color.FromArgb(50, 115, 103, 240));
        private static SolidColorBrush WinBrush =>
            _winBrush ??= new SolidColorBrush(Windows.UI.Color.FromArgb(50, 40, 199, 111));
        private static SolidColorBrush DefaultBrush =>
            _defaultBrush ??= new SolidColorBrush(Windows.UI.Color.FromArgb(50, 0, 0, 0));
